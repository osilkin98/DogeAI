...
while(list_count > 110): # Moving files into the training data directory
	...
	if(len(file_list[1]) == 0 or (random.random() <= float((len(file_list[0]))) / list_count and len(file_list[0]) != 0)):
		# pick a random doge
		random_doge = file_list[0][random.randint(0, len(file_list[0]) - 1)]
		print("Copying {} from {}{} to {}{}".format(random_doge, base_data_dirs['doge'], random_doge, training_data_dirs['doge'], random_doge))
		copyfile("{}{}".format(base_data_dirs['doge'], random_doge), "{}{}".format(training_data_dirs['doge'], random_doge))
		...
		print("Copying {} from {}{} to {}{}".format(random_notdoge, base_data_dirs['not-doge'], random_notdoge, training_data_dirs['not-doge'], random_notdoge))
		copyfile("{}{}".format(base_data_dirs['not-doge'], random_notdoge), "{}{}".format(training_data_dirs['not-doge'], random_notdoge))
...
while(list_count != 0):
	if(len(file_list[1]) == 0 or (random.random() <= float((len(file_list[0]))) / list_count and len(file_list[0]) != 0)):
		# pick a random doge
		random_doge = file_list[0][random.randint(0, len(file_list[0]) - 1)]
		print("Copying {} from {}{} to {}{}".format(random_doge, base_data_dirs['doge'], random_doge, testing_data_dirs['doge'], random_doge))
		copyfile("{}{}".format(base_data_dirs['doge'], random_doge), "{}{}".format(testing_data_dirs['doge'], random_doge))
		print("Done, removing {} from file list".format(random_doge))
		file_list[0].remove(random_doge)
	else:
		random_notdoge = file_list[1][random.randint(0, len(file_list[1]) - 1)]
		print("Copying {} from {}{} to {}{}".format(random_notdoge, base_data_dirs['not-doge'], random_notdoge, testing_data_dirs['not-doge'], random_notdoge))
		copyfile("{}{}".format(base_data_dirs['not-doge'], random_notdoge), "{}{}".format(testing_data_dirs['not-doge'], random_notdoge))
		print("Done, removing {} from file_list".format(random_notdoge))
		file_list[1].remove(random_notdoge)
	list_count -= 1
